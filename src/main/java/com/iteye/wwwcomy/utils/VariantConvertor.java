...
public class VariantConvertor {
    ...
    public static boolean before(Object d1, Object d2) {
        if (d1 instanceof java.util.Date && d2 instanceof java.util.Date) {
            return VariantConvertor.toDate(d1).before(VariantConvertor.toDate(d2));
        } else if (d1 instanceof java.lang.Integer && d2 instanceof java.lang.Integer) {
            return VariantConvertor.toInt(d1) < VariantConvertor.toInt(d2);
        } else if (d1 instanceof java.lang.String && d2 instanceof java.lang.String) {
            return VariantConvertor.toString(d1).compareTo(VariantConvertor.toString(d2)) < 0;
            ...
            return VariantConvertor.toInt(VariantConvertor.toDate(d1)) < VariantConvertor.toInt(VariantConvertor
                    .toDate(d2));
        } else {
            // TODO 需要验证
            if (d1 != null && d2 == null) {
    ...
    public static Timestamp toTimestamp(Object value) {
        ...
        if (value instanceof String) {
            ...
            // "yyyy-MM-dd HH:mm:ss");
            java.util.Date d = DateUtil.getDate(value.toString(), "yyyy-MM-dd HH:mm:ss");
    ...
    public static Date toDate(Object value) {
        if (value == null) {
            ...
            try {
                ...
                } else if ((("" + value).length() == 8) && (("" + value).lastIndexOf(":") == 5)) {
    ...
    public static int toInt(Object value) {
        if (value == null) {
            ...
            // Java Date类型Thu Jan 01 08:00:00 CST 1970的getTime == 0
            return Long.valueOf((((Date) value).getTime() + 1000 * 60 * 60 * 8) / (1000 * 60 * 60 * 24)).intValue();
    ...
    public static long toLong(Object value) {
        if (value == null) {
            ...
            // Java Date类型Thu Jan 01 08:00:00 CST 1970的getTime == 0
            return Long.valueOf((((Date) value).getTime() + 1000 * 60 * 60 * 8) / (1000 * 60 * 60 * 24));
        } else if (value instanceof BigDecimal) {
            throw new RuntimeException("No expectation");
            // BigDecimal bd = (BigDecimal)o;
            // return bd.intValue();
    ...
    public static Double toDouble(Object o) throws RuntimeException {
        ...
        if (o instanceof Double) {
            ...
            try {
                ...
                throw new RuntimeException("Incompatible type or unsupported data format");
            }
    ...
    public static Object[] toParameterTypes(Object paras[], Class[] paraTypes) {
        for (int index = 0; index < paraTypes.length; index++) {
            ...
            if (type == Integer.class || type == int.class) {
                ...
                paras[index] = Float.parseFloat(VariantConvertor.toString(paras[index]));
    ...
    public static void main(String[] args) {
        ...
        System.out.println("toTimestamp 2011-12-13 18:29:52 toTimestamp " + toTimestamp("2011-12-13 18:29:52"));
        System.out.println("toTimestamp null toTimestamp " + toTimestamp(null));
        System.out.println("toTimestamp new Date() toTimestamp " + toTimestamp(new Date()));
        System.out.println("toTimestamp long 123 toTimestamp " + toTimestamp(123));
        System.out.println("toTimestamp long 15000 toTimestamp " + toTimestamp(15000));
    }
}
